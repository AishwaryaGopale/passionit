...
const ResearchUpdate = () => {
  ...
  const GetMember = (id) => {
    axios({
      url: (API.GET_RESEARCHVIEW_API(id)),
      method: 'GET',
      headers: {
        ...
        <>
            ...
            <div class="md:col-span-5 text-center">
                <div class="inline-flex items-center justify-center p-4">
                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full ml-1" onClick={() => GoBack()}>Go Back</button>
                </div>
            </div>
        </>
    )
