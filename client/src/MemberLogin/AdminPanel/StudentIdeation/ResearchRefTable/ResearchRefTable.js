...
const ResearchRefTable = () => {
    ...
    const Delete = (id) => {
        axios({
            url: API.DELETE_RESEARCHREF_API(id),
            method: 'DELETE',
        })
        .then((res) => {
    ...
    const View = (id) => {
        ...
        navigate("/admin/refrenceaddviewresearch");
    };

    const Edit = (id) => {
        sessionStorage.setItem("user_id", id);
        navigate("/admin/refrenceaddupdateresarch");
    };
    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto pt-[30px]">
                <h3 className='p-3 font-bold text-center'>Research Reference</h3>
                                ...
                                <table className="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                    <thead className="bg-[#7f7ff5] dark:bg-[#8b8bf7]">
                                        <tr>
                                            ...
                                            <th scope="col" className="py-3 px-6 text-xs font-medium tracking-widertext-center text-gray-700 uppercase dark:text-gray-400">
                                                srnumber
                                            </th>
                                            <th scope="col" className="py-3 px-6 text-xs font-medium tracking-wider text-center text-gray-700 uppercase dark:text-gray-400">
                                                Action
...
export default ResearchRefTable;
