...
const StudentView = () => {
  ...
  const Opportunity = (id) => {
        ...
        axios({
            url: (API.POST_MEMBERSSTUDENT_API),
            method: "post",
            data: data,
              ...
              {member.map((d, k) => (
                <div key={k}>
                  ...
                  <div className='flex items-center justify-center p-4'>
                    <button class="bg-red-500 text-[white] hover:bg-red-700 hover:text-[white] font-bold py-2 px-4 rounded-full" onClick={() => DeleteMember(d.id)}>
                      Delete
                    </button>
                  ...
                  <div className='flex items-center justify-center p-3'>
                    <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-full" onClick={() => Opportunity(d.id)}>
                    &#8592; Add Opportunity
                    </button>
                  </div>
                  </div>
