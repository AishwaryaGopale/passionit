...
const ResearchEdit = () => {
  ...
  const GetMember = (id) => {
    axios.get(API.GET_RESEARCHEDITREF_API(id))
      .then((res) => {
        const data = res.data;
  ...
  const PostData = () => {
    ...
    axios.put(API.PUT_RESEARCHREF_API(id), formData)
      .then(() => {
      ...
      <div className="flex items-center justify-center min-h-screen p-6 bg-gray-100">
        <div className="container max-w-screen-lg mx-auto">
          <div>
            ...
            <p className="mb-6 text-gray-500">Refrence Form.</p>
            ...
            <div className="p-4 px-4 mb-6 bg-white rounded shadow-lg md:p-8">
              <div className="grid grid-cols-1 gap-4 text-sm gap-y-2 lg:grid-cols-3">
                <div className="text-gray-600">
                  <p className="text-lg font-medium">Refrence Form</p>
                  ...
                  <div className="grid grid-cols-1 gap-4 text-sm gap-y-2 md:grid-cols-4">
                    ...
                    <div className="text-right md:col-span-5">
                      <div className="inline-flex items-end gap-x-3">
                        <button className="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-red-700" onClick={PostData}>Update</button>
                      </div>
                      <div className="inline-flex items-end pl-3">
                        <button className="px-4 py-2 font-bold text-white bg-red-500 rounded hover:bg-red-700" onClick={GoBack}>Go Back</button>
                      </div>
                    </div>
                  </div>
                </div>
