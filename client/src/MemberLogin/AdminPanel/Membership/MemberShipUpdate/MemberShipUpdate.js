...
const MemberShipUpdate = () => {
    ...
    useEffect(() => {
      ...
      const GetMember = (id) => {
        axios({
          url: (API.GET_MEMBERSHIPRECORDS_API(id)),
          method: 'GET',
          headers: {
    ...
    const Addmebers = () => {
        ...
        alert(id)
        axios({
            url: (API.PUT_MEMBERSHIPRECORDS_API(id)),
            method: 'Put',
            data: playloas,
                                    ...
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div class="md:col-span-5 text-right">
                                            <div class="inline-flex items-end">
                                                <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={() => Addmebers()}>Update</button>
                                            </div>
                                        </div>
