...
const EditProfile = () => {
    ...
    const GetMemberMaster = () => {
        axios({
            url: (API.ADD_MEMBERSHIPMASTER_API),
            method: 'GET',
    ...
    const GetMemberType = () => {
        axios({
            url: API.ADD_MEMBERSHIPTYPE_API,
            method: 'GET',
            contentType: 'application/json',
        }).then((res) => {
    ...
    const Membercategorys = () => {
        axios({
            url: API.ADD_MEMBERSHIPCATEGORIES_API,
            method: 'GET',
            contentType: 'application/json',
        }).then((res) => {
  ...
  console.log(file);
    ...
    const addData = async() => {
        ...
        try {
            const response = await axios.post(API.POST_MEMBER_API, formData, {
                headers: {
            ...
            <div className="grid w-full h-screen grid-cols-1 sm:grid-cols-2">
                ...
                <div className='bg-[white] flex flex-col justify-center'>
                    <form className='font-semibold font-Manrope '>
                        <h1 className='text-center pt-[50px] font-Manrope text-[29px] '>Update profile </h1>
                        <div className="p-4 space-y-12 ">
                            <div className="p-4 pb-12 border-b border-gray-900/10">
                                ...
                                <div class="md:w-2/1 pl-[55px] font-Manrope font-semibold pt-[30px]  p-4 text-center">
                                    <span><div className='text-[#D62102] inline'><button onClick={() => Reg()}>back To Login</button> </div></span>
                                </div>
                            </div>
                        </div>
                    </form>
