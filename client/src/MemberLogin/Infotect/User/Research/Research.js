...
const Research = () => {
  ...
  const AddRes = () => {
    ...
    axios.post(API.POST_RESAERCH_API, data)
      .then(res => {
        alert('Success');
      })
      .catch(err => {
                ...
                <div class="lg:col-span-2">
                  <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                    ...
                    <div class="md:col-span-2">
                      ...
                      <textarea type="text" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" ref={research_topic} />
                    </div>
                    <div class="md:col-span-2">
                    ...
                    <div class="md:col-span-2">
                      ...
                      <textarea type="text" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" ref={abstract} />
                    </div>
                    <div class="md:col-span-2">
                    ...
                    <div class="md:col-span-5 text-right ">
                      <div class="inline-flex items-end gap-x-3">
                        <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={() => AddRes()}>Submit</button>
                      </div>
                      <div class="inline-flex items-end pl-3">
                        <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onClick={() => Refernce()}>Add Reference</button>
                      </div>
                    </div>
                  </div>
                </div>
